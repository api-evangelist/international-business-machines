...
**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/international-business-machines/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Cloud, Artificial Intelligence, Enterprise, IBM
...
- [OpenAPI](openapi/ibm-watsonx-ai-openapi.yml)
- [JSONSchema](json-schema/foundation-model.json)
- [JSONSchema](json-schema/text-generation-request.json)
- [JSONLD](json-ld/international-business-machines-context.jsonld)
...
- [OpenAPI](openapi/ibm-watsonx-assistant-openapi.yml)
- [JSONSchema](json-schema/assistant-message.json)
...
- [OpenAPI](openapi/ibm-natural-language-understanding-openapi.yml)
- [JSONSchema](json-schema/nlu-analysis.json)
...
#### Tags:
 ...
 - Artificial Intelligence, Speech Recognition, Audio

#### Properties

- [Documentation](https://cloud.ibm.com/apidocs/speech-to-text)
- [OpenAPI](openapi/ibm-speech-to-text-openapi.yml)
- [JSONSchema](json-schema/speech-recognition-result.json)
...
#### Tags:
 ...
 - Artificial Intelligence, Speech Synthesis, Audio

#### Properties

- [Documentation](https://cloud.ibm.com/apidocs/text-to-speech)
- [OpenAPI](openapi/ibm-text-to-speech-openapi.yml)
...
#### Tags:
 ...
 - Storage, Cloud, Objects

#### Properties

- [Documentation](https://cloud.ibm.com/docs/cloud-object-storage)
- [OpenAPI](openapi/ibm-cloud-object-storage-openapi.yml)
- [JSONSchema](json-schema/bucket.json)
...
- [OpenAPI](openapi/ibm-kubernetes-service-openapi.yml)
- [JSONSchema](json-schema/cluster.json)
...
- [OpenAPI](openapi/ibm-vpc-openapi.yml)
- [JSONSchema](json-schema/vpc.json)
